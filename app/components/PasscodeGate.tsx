...
/**
 * Phone-style PIN pad. Unlocks the shared ADMIN_PASSCODE session
 * (same cookie as /admin). Used for admin and for locking the guest app
 * when someone has no personal invite.
 */

...
export default function WelcomePage() {
  ...
  return (
    <div className="relative flex min-h-[calc(100dvh-64px)] flex-col overflow-hidden">
      ...
      />
      {/* Final darken + blend into the page's own background color, so it
          never ends as a hard edge. */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black/20 via-55% to-[color:var(--color-bg)]" />
